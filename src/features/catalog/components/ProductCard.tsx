  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-2">
        ...
        {/* Name */}
        <Link href={`/producto/${slug}`} className="block group/link">
          <h3 className="text-sm font-semibold text-white leading-snug group-hover/link:text-violet-300 transition-colors line-clamp-2">
            {name}
          </h3>
        </Link>
