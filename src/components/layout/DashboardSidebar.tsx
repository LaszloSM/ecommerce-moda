...
const NAV_ITEMS = [
  ...
  { icon: Tag, label: 'Cupones', href: '/dashboard/cupones' },
  { icon: Star, label: 'Reseñas', href: '/dashboard/reseñas' },
  { icon: Store, label: 'Mi Tienda', href: '/dashboard/tienda' },
...
function SidebarContent({ onNav }: { onNav?: () => void }) {
  ...
  const userInitial = user?.email ? user.email[0].toUpperCase() : 'V'
